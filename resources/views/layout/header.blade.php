<header id="masthead" class="site-header clearfix" itemscope itemtype="http://schema.org/WPHeader">
    <p class="site-name" itemprop="headline">Sihaayi</p>
            ...
            <div id="nav-bar" class="nav-bar" data-menu-layout="top-justify-left">
                <div class="flex-wrap">
                    <div class="logo-container"> <a href="{{ route('home') }}"></a>
                        <div class="logo loading-anim-logo">siy</div>
                        <div class="secondary-logo" style="    text-shadow: 0 0 10px #fff, 0 0 20px #ff0, 0 0 30px #f0f;
    color: red;">aahi</div>
                    </div>
    ...
    color: red;">aahi</div>
                    ...
                    <div class="hamburger-container"> <button
                            ...
                            <span class="hamburger-btn__hamburger"> <span class="hamburger-btn__span hbgl--1"></span>
                                <span class="hamburger-btn__span hbgl--3"></span> </span> </button></div>
                </div>
            </div>
        </div>
    </div>
